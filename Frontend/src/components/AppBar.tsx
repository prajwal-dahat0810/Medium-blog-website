...
export const AppBar = () => {
  ...
  return (
    <div className="border-b flex max-sm:px-3  max-sm:max-w-2xl items-center justify-between py-4 px-10">
      ...
      <div className="pr-6 flex justify-center items-center gap-4 max-sm:gap-2 ">
        <Link to={"/publish"}>
          <button
            type="button"
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          ...
          <div
            ...
            }  text-base absolute right-10  top-20 max-sm:right-3 list-none bg-white  divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600`}
            id="user-dropdown"
          >
